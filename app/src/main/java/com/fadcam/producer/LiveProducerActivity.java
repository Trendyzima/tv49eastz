...
public final class LiveProducerActivity extends Activity {
    ...
    @Override protected void onDestroy() {
        ...
        // Do not stop the relay tunnel here. RemoteStreamService is the foreground
        // owner of the live producer pipeline, while the WebSocket object is retained
        // by its callbacks for the lifetime of the process. This allows the console
        // Activity to close without cutting off a live broadcast.
        super.onDestroy();
    }
